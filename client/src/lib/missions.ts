...
export const MODELS: ModelCard[] = [
  { id: 'openai/gpt-oss-120b:nitro', name: 'Scout', tagline: 'Fast recon and cheap lane pressure; weak at sabotage and HQ cracking.', speed: 5, quality: 4, cost: 1, pts: 3, p50: 1120, beatsDeadline: true, priceIn: 0.039, priceOut: 0.18 },
  { id: 'z-ai/glm-4.7:nitro', name: 'Engineer', tagline: 'Premium fortify/sabotage/HQ push; powerful but eats crew cap.', speed: 5, quality: 5, cost: 2, pts: 5, p50: 417, beatsDeadline: true, priceIn: 0.40, priceOut: 1.75 },
