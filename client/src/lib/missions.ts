...
export const MODELS: ModelCard[] = [
  { id: 'openai/gpt-oss-120b:nitro', name: 'Scout', tagline: 'Fast recon and cheap pressure; weaker at sabotage and HQ cracking.', speed: 5, quality: 4, cost: 1, pts: 3, p50: 1120, beatsDeadline: true, priceIn: 0.039, priceOut: 0.18 },
  { id: 'z-ai/glm-4.7:nitro', name: 'Engineer', tagline: 'Best fortify/sabotage/HQ push; premium field or command pick.', speed: 5, quality: 5, cost: 2, pts: 4, p50: 417, beatsDeadline: true, priceIn: 0.40, priceOut: 1.75 },
  { id: 'inception/mercury-2:nitro', name: 'Runner', tagline: 'Balanced assault unit for racing through open lanes.', speed: 4, quality: 4, cost: 2, pts: 3, p50: 943, beatsDeadline: true, priceIn: 0.25, priceOut: 0.75 },
  { id: 'google/gemini-3.1-flash-lite:nitro', name: 'Surveyor', tagline: 'Recon specialist; good command pick, light combat punch.', speed: 4, quality: 3, cost: 2, pts: 3, p50: 893, beatsDeadline: true, priceIn: 0.25, priceOut: 1.50 },
  { id: 'z-ai/glm-4.7-flash:nitro', name: 'Skirmisher', tagline: 'Cheap assault/sabotage body, but timing can jitter.', speed: 3, quality: 3, cost: 1, pts: 1, p50: 2020, beatsDeadline: false, priceIn: 0.06, priceOut: 0.40 },
  { id: 'x-ai/grok-4.3:nitro', name: 'Oracle', tagline: 'Huge lead/recon/sabotage upside if it lands before deadline.', speed: 2, quality: 5, cost: 5, pts: 6, p50: 3291, beatsDeadline: false, priceIn: 1.25, priceOut: 2.50 },
  { id: 'google/gemini-3.5-flash:nitro', name: 'Flash', tagline: 'Slow but strong defensive and disruption calls.', speed: 2, quality: 4, cost: 4, pts: 4, p50: 5459, beatsDeadline: false, priceIn: 1.50, priceOut: 9.00 },
  { id: 'deepseek/deepseek-v4-flash:nitro', name: 'Analyst', tagline: 'Budget command/recon/sabotage option with deadline risk.', speed: 2, quality: 4, cost: 1, pts: 2, p50: 3193, beatsDeadline: false, priceIn: 0.0983, priceOut: 0.1966 },
];
